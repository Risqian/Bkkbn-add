        ...
        dataBkkbn.local.replicate.from(dataBkkbn.remote, {
            ...
            syncBkkbn = dataBkkbn.local.sync(dataBkkbn.remote, {
                ...
                if (!didCancel) {
                    ...
                    messages = [...messages, { 'content': 'Tanggal: ' + date + ' ' + time + 'status :' + info.change.docs[0].status_sensus  +' isi : '+ statusOperasi + ' pada no. KK: ' + info.change.docs[0].no_kk + ' a.n.: ' + info.change.docs[0].data_nik[0].nama_anggotakel}];
